...
- [x] Publish demo and verify public viewer — owner explicitly requested deletion of Test1 to reuse its free slot; completed without a purchase.
...
September 7 completion: Anthony explicitly requested deleting Test1 and using the prepared board for Wednesday. Verified same owner and activation cascade, deleted only Test1 through the administrative database connector, and published the prepared board through signed-in Safari on Free (1 of 1). Independent signed-out public browser rendered all 100 squares, four $100 payouts, and ESPN Pregame 0–0 with recent score freshness. Public link: https://www.getgridone.com/b/6BKE6UEQ. Database confirmed Test1 absent and new board published. No schema, general deletion policy, plan or price change.
