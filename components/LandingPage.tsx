      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 mt-8 md:mt-0">
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
                ...
                <button 
                    onClick={onJoin}
                    className="w-full md:w-auto px-10 py-5 bg-white/5 border border-white/10 rounded-full text-white font-black uppercase tracking-widest text-sm md:text-base hover:bg-white/10 hover:border-white/30 transition-all backdrop-blur-md flex items-center justify-center gap-2"
                >
                    Join a Game
                </button>
            </div>
