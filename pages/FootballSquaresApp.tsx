    ...
    <div className="oa-root min-h-screen bg-broadcast-white text-ink font-sans selection:bg-gold/30 flex flex-col overflow-x-hidden">
      ...
      <main className="mx-auto w-full max-w-4xl px-5 py-24">
        ...
        <article className="prose prose-lg max-w-none">
          <h2 className="oa-headline text-2xl font-semibold text-ink mt-12 mb-6">The real job</h2>
          <p className="text-ink/80 leading-relaxed mb-6">The real job of a football squares app is to replace screenshots, spreadsheet cleanup, and manual winner checking with one clean experience.</p>

          <h2 className="oa-headline text-2xl font-semibold text-ink mt-12 mb-6">Best-fit audiences</h2>
          ...
          <h2 className="oa-headline text-2xl font-semibold text-ink mt-12 mb-6">What to look for</h2>
          <ul className="space-y-3 text-ink/80">
